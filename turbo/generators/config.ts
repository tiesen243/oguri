    ...
    prompts: [
      {
        ...
        name: 'packageName',
        message:
          'What is the name of the package? (You can skip the `@oguri/` prefix)',
      },
      {
        type: 'input',
        name: 'deps',
    ...
    actions: [
      (answers) => {
        if (
          ...
          if (answers.packageName.startsWith('@oguri/'))
            answers.packageName = answers.packageName.replace('@oguri/', '')
        }
